...
Player::Player()
{
...

	{
		...
		animation_attack_left.set_inerval(0.05f);
		...
		animation_attack_right.set_inerval(0.05f);
	...
	}
	{
		...
		animation_dead_left.set_inerval(0.1f);
		...
		animation_dead_right.set_inerval(0.1f);
	...
	}
	{
        ...
        animation_idle_left.set_inerval(0.15f);
        ...
        animation_idle_right.set_inerval(0.15f);
	...
	}
	{
        ...
        animation_jump_left.set_inerval(0.15f);
        ...
        animation_jump_right.set_inerval(0.15f);
	...
	}
	{
		...
		animation_run_left.set_inerval(0.075f);
        ...
        animation_run_right.set_inerval(0.075f);
	...
	}
	{
        ...
        animation_roll_left.set_inerval(0.05f);
        ...
        animation_roll_right.set_inerval(0.05f);
	...
	{
		animation_slash_up.set_inerval(0.07f);
        ...
        animation_slash_down.set_inerval(0.07f);
        ...
        animation_slash_left.set_inerval(0.07f);
        ...
        animation_slash_right.set_inerval(0.07f);
        ...
        animation_jump_vfx.set_inerval(0.05f);
		...
		animation_land_vfx.set_inerval(0.01f);
...
void Player::update_attack_dir(int x, int y)
{
	...
	else if (angle >= PI * 3 / 4 && angle <= PI || angle < -PI * 3 / 4 && angle >= -PI)
